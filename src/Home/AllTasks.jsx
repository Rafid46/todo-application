...
const AllTasks = () => {
  ...
  return (
    <div>
      {tasks.map((task) => (
        <div
          className="w-96 rounded-md bg-transparent m-5 border-2 border-gray-300 p-5 pt-5 pb-0
 cursor-move"
        >
          <div className="shadow-lg backdrop-blur-sm bg-opacity-20 bg-white w-fit mx-auto gap-5 border-gray-400 rounded-md p-2">
